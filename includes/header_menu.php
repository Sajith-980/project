...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Apiral 360 | Online Shopping Site for Men like Sajith</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#watch" class="dropdown-item">kathi_Watches</a>
                                   <a href="products.php#shirt" class="dropdown-item">TT-Shirts</a>
                                   <a href="products.php#shoes" class="dropdown-item">Noice_Shoes</a>
